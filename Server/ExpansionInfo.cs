		...
		private static ExpansionInfo[] m_Table = new ExpansionInfo[]
			{
				...
				new ExpansionInfo( 6, "Samurai Empire",		ClientFlags.Tokuno,		FeatureFlags.ExpansionSE,	CharacterListFlags.ExpansionSE,		0x00C0 ), // 0x40 | 0x80
				new ExpansionInfo( 7, "Mondain's Legacy",	new ClientVersion( "5.0.0a" ),	FeatureFlags.ExpansionML,	CharacterListFlags.ExpansionML,		0x02C0 ), // 0x40 | 0x80 | 0x200
				new ExpansionInfo( 8, "Stygian Abyss",		ClientFlags.TerMur,		FeatureFlags.ExpansionSA,	CharacterListFlags.ExpansionSA,		0xD02C0 ), // 0x40 | 0x80 | 0x200 | 0x10000 | 0x40000 | 0x80000
				new ExpansionInfo( 9, "High Seas",		new ClientVersion( "7.0.9.0" ),		FeatureFlags.ExpansionHS,	CharacterListFlags.ExpansionHS,		0xD02C0 ) // 0x40 | 0x80 | 0x200 | 0x10000 | 0x40000 | 0x80000
			};
